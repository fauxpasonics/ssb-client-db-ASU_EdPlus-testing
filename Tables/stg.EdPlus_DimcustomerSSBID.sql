CREATE TABLE [stg].[EdPlus_DimcustomerSSBID]
(
...
GO
CREATE CLUSTERED INDEX [IDC_Stg_EdPlus_Dimcustomerssbid] ON [stg].[EdPlus_DimcustomerSSBID] ([DimCustomerSSBID]) WITH (DATA_COMPRESSION = PAGE)
GO
