CREATE TABLE [stg].[EdPlus_CompositeRecord]
(
...
GO
CREATE CLUSTERED INDEX [IDC_Stg_EdPlus_compositerecord] ON [stg].[EdPlus_CompositeRecord] ([DimCustomerId]) WITH (DATA_COMPRESSION = PAGE)
GO
