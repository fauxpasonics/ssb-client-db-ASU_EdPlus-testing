CREATE TABLE [stg].[EdPlus_Dimcustomer]
(
...
GO
CREATE CLUSTERED INDEX [IDC_Stg_EdPlus_Dimcustomer] ON [stg].[EdPlus_Dimcustomer] ([DimCustomerId]) WITH (DATA_COMPRESSION = PAGE)
GO
